...
export const initTreatmentVariables = (): ITreatmentVariablesQuestionnaireResponse => ({
    ...
    item: [
        ...
        { linkId: "PREBRTTOTDOSE", answer: [{ valueQuantity: undefined }] },
        { linkId: "PREBRTDOSEPERFRACT", answer: [{ valueQuantity: undefined }] },
        ...
        { linkId: "SVEBRTTOTDOSE", answer: [{ valueQuantity: undefined }] },
        { linkId: "SVEBRTDOSEPERFRACT", answer: [{ valueQuantity: undefined }] },
